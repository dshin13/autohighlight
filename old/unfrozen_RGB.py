...
if __name__ == '__main__':
    ...
    dims = (250,224,224,3)
    batch_size = 1
    videogen = VideoGenerator(train_dir, test_dir, dims, batch_size)
    ...
    # Load model
    test_model = load_model('./weights/0612_RGB_finetune_1epoch.hdf5')
    
    # Unfreeze I3D model
    freeze_RGB_model(test_model, trainable=True)
